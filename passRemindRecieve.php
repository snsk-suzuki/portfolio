      ...
      if(empty($err_msg)){
        ...
        try {
          ...
          if($stmt){
            ...
            $subject = '【パスワード再発行完了】｜FitnessRecord';
...
ログインページ：http://localhost:8888/fitness_record/login.php
再発行パスワード：{$pass}
      ...
      <form action="" method="post" class="form">
        <div class="form-fieldset">
          <label class="<?php if(!empty($err_msg['token'])) echo 'err' ?>">
              <div class="input-msg">
                <span class="input-title">認証キー</span>
                <span class="area-msg">
        ...
        <input type="submit" class="btn btn-mid" value="再発行する" name="submit">
      </form>
    </div>
