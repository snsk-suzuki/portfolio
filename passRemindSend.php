    ...
    if(empty($err_msg)){
      ...
      try {
        ...
        if($stmt && array_shift($result)){
          ...
          $to = $email;
          $subject = '【パスワード再発行認証】｜FitnessRecord';
...
パスワード再発行認証キー入力ページ：http://localhost:8888/fitness_record/passRemindRecieve.php
認証キー：{$auth_key}
※認証キーの有効期限は30分となります
  ...
  <section id="main">
    <div class="form-container">
      <form action="" method="post" class="form">
        ...
        <input type="submit" class="btn btn-mid" value="送信する" name="submit">
      </form>
    </div>
